...
In the space below, write the name of the course from the first row of the "name" column. **Answer: LING889 Directed Research**
...
**Answer: 9 columns and 79,366 rows**
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer:** We added the instruction (arrange(desc(count classes)) and the data was then organized
